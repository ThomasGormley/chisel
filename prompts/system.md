...
**Input:**
<USER_DIRECTIVE>Rename to 'execute'</USER_DIRECTIVE>
<SOURCE_CODE>
void run() {
// @ai Rename to 'execute'
start();
}
</SOURCE_CODE>

**Response:**
Reasoning: Renaming function and stripping the @ai directive.
[edit(path, "void run() {\n // @ai Rename to 'execute'", "void execute() {")]
